...
def gen_db():
    ...
    #Rendering.create(width=1200, height=800, samples=128, max_iterations=8, scene=glsl_scene).save()
    Rendering.create(width=600, height=400, samples=32, max_iterations=8, scene=another_glsl_scene).save()
