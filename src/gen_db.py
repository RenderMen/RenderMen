...
def gen_db():
    ...
    #Rendering.create(width=1000, height=600, samples=32, scene=glsl_scene).save()
    Rendering.create(width=1000, height=600, samples=64, scene=another_glsl_scene).save()
